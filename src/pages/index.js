    ...
    <div className={styles['container']}>
      ...
      <div className={styles['container2']}>
        <div className={styles['hero']}>
          <div className={styles['hero-text-container']}>
            ...
            >
              <span>ENG1 TEAM15</span>
              <br></br>
            </h1>
            <span>
              <span>Explain why our game is easily refactorable with Json</span>
              <br></br>
              <br></br>
            </span>
      ...
      <div className={styles['features']}>
        <div className={styles['heading-container']}>
          <h2
            className={` ${styles['text09']} ${projectStyles['section-heading']} `}
          >
            Deliverables
          </h2>
          <span
            className={` ${styles['text10']} ${projectStyles['section-text']} `}
          >
        ...
        <div className={styles['cards-container']}>
          <div className={styles['card']}>
            ...
            <div className={styles['content-container']}>
              ...
              >
                <span>Here is our Java Game</span>
                <br></br>
                <span>Link above image when we have a download</span>
                <br></br>
                <br></br>
              </span>
            </div>
          ...
          <div className={styles['card1']}>
            ...
            <div className={styles['content-container1']}>
              <span className={styles['heading4']}>
                <span
                  className={` ${projectStyles['card-heading']} ${projectStyles['card-heading']} `}
                >
                  PDFs
                </span>
                <br></br>
              ...
              >
                <span>Link PDFs With above image</span>
                <br></br>
              </span>
            </div>
          </div>
      ...
      <div className={styles['about']}>
        <div className={styles['max-content-width-container']}>
          <div className={styles['heading-container1']}>
            <h1
              className={` ${projectStyles['section-heading']} ${styles['text27']} `}
            >
      ...
      <div className={styles['clients']}>
        <div className={styles['heading-container2']}>
          ...
          <span
            className={` ${styles['text42']} ${projectStyles['section-text']} `}
          >
            <span>Make these easier to fullsize</span>
            <br></br>
          </span>
        </div>
      ...
      <div className={styles['faqs']}>
        <h2
          className={` ${styles['text45']} ${projectStyles['section-heading']} `}
        >
